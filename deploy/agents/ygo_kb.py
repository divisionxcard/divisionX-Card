...
def build(only=None):
    ...
    doc = {
        ...
        "_db_notes": [
            "✅ แก้แล้ว 24 ส.ค. 2026 — skus.language ของทั้ง 4 SKU เป็น JA "
            "(ยืนยันจากรูปซองจริง 3 ใบ: มี 対象年齢9才以上 และเครดิต "
            "©スタジオ・ダイス／集英社・テレビ東京・KONAMI · "
            "The Heroes ไม่มีรูปเพราะยังไม่เคยลงตู้ แต่เป็นชุดพี่น้องของ THE RIVALS "
            "ในไลน์ LIMIT OVER COLLECTION เดียวกัน และ Konami มีเฉพาะฉบับญี่ปุ่น)",
            "⏸️ set_code ยังเป็นของเดิม (CHAOS/HEROES/REVALS) ไม่ใช่รหัสทางการ "
            "(CORI/LOCH/LOCR) — เจ้าของสั่งไม่ให้เปลี่ยน เพราะแอดมินคุ้นกับรหัสเดิม "
            "ดูเหตุผลเต็มที่ wiki/kb-research/kayou-sku-mapping-todo.md",
            "ℹ️ sku_id 'YGH The Revals' สะกดผิด แต่ช่อง name ในฐานข้อมูลถูกแล้ว "
            "('Yu-Gi-Oh The Rivals') — sku_id เป็นคีย์หลัก อย่าไปแก้",
        ],
