...
# ชุดไทยที่ตรงกับสินค้าในตู้เรา — ดู __doc__ เรื่องไลน์ญี่ปุ่น/ไทยไม่ตรงกัน
# รหัสญี่ปุ่นยืนยันจากรูปซองจริงที่เจ้าของส่งมา 24 ส.ค. 2026 ครบทั้ง 3 ซอง
# และแก้ skus.set_code / language ในฐานข้อมูลให้ตรงแล้ว (M2a/M4/M5 · JA)
OUR_SETS = {
    "MA3": {"our_sku": "PKM Dream EX", "jp_code": "M2a",
            "jp": "ハイクラスパック MEGA ドリームex · 10 ใบ/ซอง"},
    "MA5": {"our_sku": "PKM Ninja + PKM Ghost", "jp_code": "M4 + M5",
            "jp": "ไทยรวม 拡張パック ニンジャスピナー (M4 · 5 ใบ/ซอง) "
                  "กับ 拡張パック アビスアイ (M5 · 5 ใบ/ซอง) เข้าเป็นชุดเดียว"},
}
