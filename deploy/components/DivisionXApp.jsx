    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-8">
        ...
        <div className="flex flex-col items-center mb-8">
          <img src="/logo-white.png" alt="DivisionX Card" className="w-24 h-24 object-contain mb-3"/>
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className={`fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-100 shadow-sm z-40 flex flex-col transition-transform duration-300
        ...
        <div className="p-5 border-b border-gray-100">
          <div className="flex items-center gap-3">
            <img src="/logo-white.png" alt="DivisionX Card" className="w-9 h-9 object-contain"/>
            <div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-4 lg:p-6 overflow-y-auto">
          {page === "dashboard"  && <PageDashboard stockIn={stockIn} stockOut={stockOut} stockBalance={stockBalance} skus={skus} transfers={transfers} machineStock={machineStock} sales={sales} machines={machines} profile={profile} onAddLot={() => { setStockInitialTab("addin"); setPage("stock") }}/>}
          {page === "stock"      && <PageStock     stockIn={stockIn} stockBalance={stockBalance} skus={skus} initialTab={stockInitialTab} profile={profile} onAddStockIn={addStockIn} onUpdateStockIn={updateStockIn} onDeleteStockIn={deleteStockIn} onAddSku={addSku} onDeactivateSku={deactivateSku} onSkuRefresh={async () => setSkus(await getSkus())} onRecalcAvgCost={async (skuId) => { await recalcAvgCost(skuId); setSkus(await getSkus()) }}/>}
          ...
          {page === "machstock"  && <PageMachineStockView machines={machines} machineStock={machineStock} skus={skus} onRefresh={loadAll} profile={profile}/>}
