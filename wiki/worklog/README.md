...
- [[2026-08-24-stock-sync-silent-skip]] — ซิงค์สต็อกไม่เข้า 3 วันโดย workflow ขึ้นเขียว · ignore_duplicates ที่ถูกกับ sales แต่ผิดกับ machine_stock
- [[2026-08-24-prb02-quantity-repair]] — ซ่อมจำนวนซอง PRB-02 ที่นับผิด 31 แถวจากอักขระ U+0E3A ในชื่อ · +279 ซอง เงินไม่เปลี่ยน
...
- [[2026-09-03-vms-product-id]] — VMS: เลิกเดาสินค้าจากเลขช่อง อ่านรหัสสินค้าจากบิลแทน + ย้อนซ่อม 6,890 แถว
