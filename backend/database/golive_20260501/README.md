...
- **Main** (คลังหลัก): นับ Cotton ครบ + Box ครบ + ซองเหลือ + ราคาทุน/ซอง
- **User** (ของแอดมินที่ **เหลือในมือ หลังเติมตู้แล้ว**): username + SKU + ซอง
  - ⚠ สำคัญ — นับ "หลังเติมตู้" ไม่ใช่ก่อนเติม · ตัวเลขนี้คือยอดที่จะบันทึกใหม่ในระบบ
